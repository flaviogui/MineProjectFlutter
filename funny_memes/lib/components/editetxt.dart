...
class EditText extends StatefulWidget {
  ...
  final EditTextControler control =
      EditTextControler('', 0, 0, 0x000000, 0x000000, 0, 0);
  EditText({super.key});
  @override
...
class EditTextControler {
  ...
  int width;
  int height;
  EditTextControler(this.text, this.posX, this.posY, this.borderColor,
      this.textColor, this.height, this.width);
